...
args_eval = {
    ...
    # change in case you are not evaluating the same model that you are training

    'ONLY_TEST': False,
    # set to `True` ONLY IF running on test set (not dev set or anything else)

    'EVALUATION_SET': '',
    # path to csv with evaluation set

    'LANGUAGES': ['en', 'fr', 'ge', 'it', 'po', 'ru', 'ka', 'gr', 'es'],
    # select which languages to evaluate, packaged in a list. # e.g. ['en', 'fr', 'ge', 'it', 'po', 'ru', 'ka', 'gr', 'es'],
